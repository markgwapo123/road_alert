...
import { MapPinIcon, ChartBarIcon, DocumentTextIcon, UserIcon, ChevronDownIcon, CogIcon, KeyIcon, UserPlusIcon, ArrowRightOnRectangleIcon, ShieldCheckIcon } from '@heroicons/react/24/outline'
...
const Navbar = () => {
  ...
  const navigation = [
    ...
    { name: 'User Verifications', href: '/admin/verifications', icon: ShieldCheckIcon },
