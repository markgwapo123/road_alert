...
const Users = () => {
  ...
  const getStatCardStyle = (cardType) => {
    ...
    return `bg-white rounded-lg shadow-md p-6 cursor-pointer transition-all duration-200 transform hover:scale-105 hover:shadow-lg ${isActive ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:bg-gray-50'
      }`
  }
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2">
                          <span className={`inline-flex items-center px-2 py-1 rounded-full text-sm font-medium ${selectedUser.isFrozen
                          ...
                          <button
                            ...
                            className={`px-3 py-1 text-xs font-medium rounded-md transition-colors ${selectedUser.isFrozen
                          ...
                          {report.images && report.images.length > 0 && getImageSrc(report.images[0]) && (
                            <div className="mt-2 flex items-center">
                              <img
                                ...
                                loading="lazy"
                              />
                              <div className="h-12 w-12 rounded border mr-2 bg-gray-100 items-center justify-center text-gray-400" style={{ display: 'none' }}>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <span className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${selectedReport.severity === 'high' ? 'bg-red-100 text-red-800' :
