    ...
    try {
      ...
      if (i === 1) {
        options.auth = {
          ...
          password: 'P0tLG6YhSS0WBMyl'
        };
      } else if (i === 2) {
        connectionStrings[2] = 'mongodb+srv://markstephenmagbatos:P0tLG6YhSS0WBMyl@cluster0.mx6qk3q.mongodb.net/roadalert?retryWrites=true&w=majority&appName=Cluster0';
      }
