...
async function createAdmin() {
  try {    // Connect directly with connection string
    await mongoose.connect('mongodb+srv://markstephenmagbatos:P0tLG6YhSS0WBMyl@cluster0.mx6qk3q.mongodb.net/roadalert?retryWrites=true&w=majority&appName=Cluster0');
