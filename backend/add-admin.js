...
async function createAdmin() {
  try {
    const mongoURI = process.env.MONGODB_URI || 'mongodb+srv://markstephenmagbatos:your_password@cluster0.mx6qk3q.mongodb.net/roadalert?retryWrites=true&w=majority&appName=Cluster0';
